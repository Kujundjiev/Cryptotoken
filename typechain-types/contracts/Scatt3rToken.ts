...
export interface Scatt3rTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface Scatt3rToken extends BaseContract {
  connect(runner?: ContractRunner | null): Scatt3rToken;
  waitForDeployment(): Promise<this>;

  interface: Scatt3rTokenInterface;
